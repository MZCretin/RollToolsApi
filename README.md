...
**随着之前的群的人数越来越多（超过一百人），带来一定的不便之处，所以新增第N个交流群，~~可直接扫描二维码添加群（图二）~~（近期有不少人扫描入群之后发布一些广告，游戏，色情信息，现在关闭二维码入群的方式），如果群二维码失效或者其他原因无法进群的，可添加我好友，我手动拉你入群！也或者如果你不希望进入新群，新进入之前的人数较多的群，可添加我，我拉你进去！**
